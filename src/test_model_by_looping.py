...
'''
Goal: test the model that you have trained on a problem outside of the training set by having it try n times to generate a solution to the problem
(no gumbel noise, no reinforcement learning)
'''

if __name__ == '__main__':
    #give test prompt
    prompt = "Add A to both sides: x + A + y= B -->"
